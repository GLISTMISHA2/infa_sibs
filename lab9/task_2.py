'''Реализуйте на языке Python программу рандомной генерации магичесткого квадрата. (Что такое
магический квадрат? Читай тут -> https://ru.wikipedia.org/wiki/Магический_квадрат)
'''
import random as r
